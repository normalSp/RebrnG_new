...
- `example.md` 的主参考对象是最后一局完整的“盗天传承人”体验流：人生重开设置、长正文推进、强叙事选择、选择后结果反馈和阶段式推进。
- `example.md` 前半部分修正前的超模天赋、无代价抢原著机缘、硬改写方源等内容只作为反例和风险样本，不作为 Sprint 3 设计目标。
...
- 每个 Phase 完成后验证、中文提交并推送当前 Sprint 3 worktree 分支 `codex/sprint3-phase1-setup-content`。
